/* ============================================================
 * noiselib.js — 前端视觉噪声原语 (仅贴图/纸纹用, 不含任何世界地图逻辑)
 *
 * 服务端权威重构后, 世界噪声 mapgen 已整体移入 Server/Zongmen/Engine/js;
 * textures.js 仅需 3 个"贴图专用"确定性原语来生成纸纹/枯笔/纤维图:
 *   mulberry32(seed)  可播种 PRNG
 *   SimplexNoise(rand) 2D Simplex (Gustavson 公版)
 *   fbm(noise,x,y,oct)  分形布朗叠加
 * 以下代码从 Server/.../Engine/js/noise.js 原样摘取 (位级一致),
 * 固定种子 → 每次加载生成与旧版完全一致的纯视觉贴图。
 * ============================================================ */
(function (global) {
  'use strict';
